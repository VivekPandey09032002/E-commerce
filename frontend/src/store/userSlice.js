...
export const fetchUser = createAsyncThunk("user/fetch", async () => {
  ...
  try {
    const res = await instance.get("http://localhost:4000/api/v1/me")
    return res.data
  } catch (e) {
    throw Error(e)
  }
...
export const logOutUser = createAsyncThunk("user/logout", async () => {
  ...
  try {
    await instance.get("http://localhost:4000/api/v1/logout")
  } catch (e) {
    throw Error(e)
  }
})
...
export const fetchNewDetail = createAsyncThunk(
  ...
  async (body) => {
    ...
    try {
      await instance.put("http://localhost:4000/api/v1/me/update", body)
      const res = await instance.get("http://localhost:4000/api/v1/me")
      return res.data
    } catch (e) {
      throw Error(e)
...
export const sendResetEmail = createAsyncThunk(
  ...
  async (body) => {
    ...
    try {
      await instance.post("http://localhost:4000/api/v1/password/forgot", body)
    } catch (e) {
      throw Error(e)
    }
  }
